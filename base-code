...
echo.
echo 1) Begin!
echo 2) Load up a previous save. [Very Glitchy]
echo 3) Exit.
echo 4) Look at the update notes.
echo. 
set /p c=Choice: 
if "!c!" == "1" goto new
if "!c!" == "3" exit
...
:add 
set /a po=%hp% + %level% + %exp% + %exptill% + !weapon! + !playerdmg! + %gold% + %dmggain% + !floor! + !location!
echo %hp% %lvl% %exp% %exptill% !weapon! !playerdmg! %gold% %dmggain%
echo Save
goto save
...
:save
cls
echo Enter the name of the save you would like.
set /p svname=
(
echo %hp%      
echo %level%
...
:adventure
cls
if !slainm! == "5" set /a monster1hp=40
if !slainm! == "5" set /a monster1dmg=10
...
echo ------------------------------------
echo.
echo Save DOES NOT WORK most of the time
